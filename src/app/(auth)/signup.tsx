...
export default function SignUpScreen() {
  ...
  const { signUpWithEmail, signInWithGoogle, setPendingEmail, setPendingPassword, isLoading } =
    useAuthStore();
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      const referralCode = mmkv.getString('referral_code') ?? undefined;
      ...
      AppLogger.info('SignUpScreen', 'Sign up successful', { needsVerification });
...
// ─── Themes ───────────────────────────────────────────────────────────────────
const light = {
  bg: '#fff', text: '#000', textSecondary: '#666',
  inputBg: '#F4F4F6', border: '#E0E0E6', icon: '#888', placeholder: '#aaa',
};
const dark = {
  bg: '#000', text: '#fff', textSecondary: '#888',
  inputBg: '#1A1A1C', border: '#2C2C2E', icon: '#666', placeholder: '#555',
};
...
const styles = StyleSheet.create({
  ...
  logoLetter: { color: '#fff', fontSize: 36, fontWeight: '800', letterSpacing: -1 },
  ...
  inputWrapper: {
    ...
    borderWidth: 1, paddingHorizontal: 16, paddingVertical: 14, gap: 12,
  },
  ...
  googleButton: {
    ...
    borderRadius: 14, borderWidth: 1, paddingVertical: 15, gap: 10,
  },
