...
const SLIDES: OnboardingSlide[] = [
  ...
  },
  {
    id: '2',
    title: 'Share Moments',
    description: 'Share your life updates with Zaps, Stories, and short videos.',
    Icon: Share2,
  },
  {
    id: '3',
    title: 'Discover Content',
    description: "Explore trending topics and discover new creators you'll love.",
    Icon: Compass,
  },
];
...
function Slide({ item, width }: { item: OnboardingSlide; width: number }) {
  ...
  return (
    <View style={[styles.slide, { width }]}>
      ...
      <Text style={[styles.slideTitle, isDark && styles.textLight]}>{item.title}</Text>
